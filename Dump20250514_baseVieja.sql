CREATE DATABASE  IF NOT EXISTS `supermercadodbviejo` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `supermercadodbviejo`;
...
-- Dump completed on 2025-05-14 12:02:49
...
SELECT id, nombre, precio FROM productos WHERE nombre = 'Arroz largo fino 1Kg';